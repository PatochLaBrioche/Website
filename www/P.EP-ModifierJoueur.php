...
<table class = "tableau">
    ...
    <?php foreach ($joueurs as $joueur) : ?>
        <tr>
            ...
            <td>
                <!-- Bouton "Modifier" pour chaque ligne du tableau -->
                <form action="P.EP-ModifierJoueur2.php" method="post">
                  <input type="hidden" name="num_license" value="<?php echo $joueur['num_license']; ?>">
                  <input type="submit" value="Modifier">
                </form>
            </td>
            <td>
                <!-- Bouton "Modifier" pour chaque ligne du tableau -->
                <form action="P.EP-SupprimerJoueur.php" method="post">
                  <input type="hidden" name="num_license" value="<?php echo $joueur['num_license']; ?>">
                  <input type="submit" value="Supprimer" onclick="return confirm('Voulez vous vraiment supprimer ce joueur ?');">
                </form>
            </td>
        </tr>
    <?php endforeach; ?>
